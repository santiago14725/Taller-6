...
public class PanelMapaVisualizar extends JPanel
{
    ...
    {
        g2d.setColor(Color.RED); // Usa color rojo para los marcadores
        for (Restaurante restaurante : restaurantes)
        {
            // Obtiene las coordenadas y el nombre del restaurante
            int x = restaurante.getX();
            int y = restaurante.getY();
            String nombre = restaurante.getNombre();

      
            g2d.fillOval(x - 5, y - 5, 10, 10); // Un círculo centrado en (x, y)
